  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="description" content={country.seoDescription} />
        <meta name="keywords" content={`كلمات مفتاحية ${country.nameAr}, SEO ${country.nameAr}, تحسين محركات البحث, بحث الكلمات المفتاحية`} />
        <link rel="canonical" href={`https://keyrank.app/country/${country.code}`} />
        <meta property="og:title" content={country.seoTitle} />
        <meta property="og:description" content={country.seoDescription} />
        <meta property="og:type" content="website" />
        <meta property="og:locale" content="ar_SA" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content={country.seoTitle} />
        <meta name="twitter:description" content={country.seoDescription} />
