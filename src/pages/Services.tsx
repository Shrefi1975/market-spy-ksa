...
const services = [
  {
    ...
    description: "اكتشف الكلمات المفتاحية الأكثر بحثاً في السوق السعودي مع تحليل دقيق لحجم البحث والمنافسة",
    features: [
      "تحليل 50,000+ كلمة مفتاحية سعودية",
      "تصنيف حسب المدينة والمنطقة",
  ...
  },
  {
    ...
    description: "استفد من المواسم السعودية الهامة مع تنبيهات ذكية قبل كل موسم",
    features: [
      "تتبع اتجاهات رمضان والعيد",
      "تحليل اليوم الوطني والتأسيس",
      "تنبيهات استباقية",
      "توصيات محتوى موسمية",
    ],
  },
  {
    ...
    description: "اعرف كلمات منافسيك واكتشف الفجوات في استراتيجيتهم",
    features: [
  ...
  },
  {
    ...
    description: "احصل على تقارير مفصلة وقابلة للتنفيذ لتحسين موقعك",
    features: [
      "تقارير PDF احترافية",
  ...
  },
  {
    icon: FileText,
    title: "تحسين المحتوى",
    description: "اقتراحات ذكية لتحسين محتوى موقعك بناءً على بيانات البحث",
    features: [
      "تحليل كثافة الكلمات",
  ...
  },
  {
    icon: Users,
    title: "استشارات SEO",
    description: "جلسات استشارية مع خبراء SEO سعوديين لتحسين استراتيجيتك",
    features: [
      "جلسات فردية مع خبراء",
      "استراتيجية مخصصة",
      "متابعة شهرية",
      "تدريب الفريق",
    ],
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
              نقدم مجموعة متكاملة من الخدمات المصممة خصيصاً لمساعدتك على النجاح في السوق السعودي
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-xl text-primary-foreground/80 mb-8 max-w-2xl mx-auto">
              ابدأ الآن واحصل على تحليل مجاني لموقعك
            </p>
            <Link to="/">
