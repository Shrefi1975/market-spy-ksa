...
const faqs = [
  {
    ...
    answer: "KeyRank هي أداة تحليل كلمات مفتاحية متخصصة للأسواق العربية. تحلل موقعك ونشاطك التجاري، ثم تقترح كلمات مفتاحية ذهبية مع عناوين SEO وأوصاف Meta جاهزة للاستخدام."
  },
  {
    question: "ما هي الدول العربية المدعومة؟",
    answer: "ندعم 23 دولة عربية تشمل: السعودية، الإمارات، مصر، الكويت، قطر، البحرين، عُمان، الأردن، فلسطين، العراق، لبنان، سوريا، اليمن، المغرب، الجزائر، تونس، ليبيا، السودان، موريتانيا، الصومال، جيبوتي، جزر القمر، وتشاد."
  },
  {
