...
const faqs = [
  {
    ...
    answer: "KeyRank هي أداة تحليل كلمات مفتاحية متخصصة للسوق السعودي. تستخدم الذكاء الاصطناعي المتقدم لتحليل موقعك ونشاطك التجاري، ثم تقترح كلمات مفتاحية ذهبية مع عناوين SEO وأوصاف Meta جاهزة للاستخدام."
  },
  {
    question: "هل البيانات التي تقدمونها حقيقية ودقيقة؟",
    answer: "نعم، نستخدم بيانات حقيقية من محركات البحث ونحللها بناءً على السوق السعودي والمواسم المحلية. نسبة دقة التحليل لدينا تصل إلى 100% بناءً على تقييمات عملائنا."
  },
  {
    question: "كم عدد الكلمات المفتاحية التي سأحصل عليها؟",
    answer: "ستحصل على 20-30 كلمة مفتاحية متنوعة تشمل كلمات رئيسية، كلمات طويلة الذيل، وأسئلة شائعة يبحث عنها جمهورك المستهدف في السعودية."
  },
  {
  ...
  {
    question: "هل يمكنني استهداف مناطق محددة في السعودية؟",
    answer: "نعم، يمكنك اختيار استهداف كامل المملكة أو مناطق محددة مثل الرياض، جدة، الدمام، مكة المكرمة، أو المدينة المنورة للحصول على نتائج أكثر دقة."
  }
];
