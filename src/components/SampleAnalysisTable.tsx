...
const sampleKeywords = [
  {
    ...
    seoTitle: "أفضل العطور الرجالية الفخمة في السعودية | عطور أصلية 2024",
    metaDescription: "اكتشف تشكيلة العطور الرجالية الفخمة والأصلية. عطور ماركات عالمية بأسعار منافسة مع توصيل سريع لجميع مناطق المملكة.",
    competition: "medium",
    trend: "up",
  },
  {
  ...
  },
  {
    ...
    seoTitle: "ملابس نسائية صيفية أنيقة | موضة 2024 السعودية",
    metaDescription: "أحدث تصاميم الملابس النسائية الصيفية. فساتين، بلوزات وتنانير بأقمشة مريحة. توصيل سريع لكافة المناطق.",
    competition: "low",
    trend: "stable",
  },
  {
        ...
        >
          <div className="text-center p-8 bg-gradient-to-r from-primary/10 via-accent/10 to-primary/10 rounded-3xl border border-primary/20">
            ...
            <p className="text-muted-foreground mb-6">
              ابدأ تجربتك المجانية الآن واكتشف الفرص الذهبية لنجاحك في السوق السعودي
            </p>
            <Button
