...
const HeroSection: React.FC = () => {
  ...
  return <section className="relative min-h-[80vh] overflow-hidden pt-20">
      {/* Background */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          delay: 0.2
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              ...
              {/* Central SEO Text */}
              <motion.div className="relative z-10 text-center" animate={{
              scale: [1, 1.05, 1]
            }} transition={{
              duration: 3,
              repeat: Infinity,
              ...
              return <motion.div key={index} className="absolute" style={{
                left: `calc(50% + ${x}px)`,
                top: `calc(50% + ${y}px)`,
                ...
                ease: "easeInOut"
                    ...
                    <div className="p-2 lg:p-3 rounded-xl bg-white/10 backdrop-blur-sm border border-white/20">
                      <Icon size={20} className="text-primary lg:w-6 lg:h-6" strokeWidth={1.5} />
                    </div>
                  </motion.div>;
            })}
            </div>
            ...
            {/* Floating particles */}
            {[...Array(12)].map((_, i) => <motion.div key={`particle-${i}`} className="absolute w-2 h-2 rounded-full bg-primary/40" style={{
