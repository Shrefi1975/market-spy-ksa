            ...
            <div className="grid gap-5">
              ...
              <div className="relative">
                ...
                <div className="relative">
                  ...
                  <Input type="url" placeholder="https://example.com" value={url} onChange={e => setUrl(e.target.value)} className="pr-12 h-12 text-base bg-background/80 border-border/50 rounded-xl focus:border-primary" required />
                </div>
              </div>
              ...
              <div className="relative">
                ...
                <div className="relative">
                  ...
                  <Textarea placeholder="صف منتجك أو خدمتك باختصار..." value={description} onChange={e => setDescription(e.target.value)} className="pr-12 min-h-[100px] text-base bg-background/80 border-border/50 rounded-xl resize-none focus:border-primary" required />
                </div>
              </div>
