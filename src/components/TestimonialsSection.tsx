...
const testimonials = [
  {
    ...
    location: "الرياض",
    content: "بفضل KeySaudi، زادت مبيعاتي بنسبة 150% خلال 3 أشهر فقط. الكلمات المفتاحية المقترحة كانت دقيقة جداً وساعدتني في استهداف العملاء الصحيحين.",
    rating: 5,
  },
  {
    name: "سارة المنصور",
  ...
  },
  {
    ...
    location: "الدمام",
    content: "كنت أبحث عن أداة تفهم السوق المحلي، وأخيراً وجدتها! KeySaudi غيّرت طريقة تفكيرنا في SEO وزادت حركة الزوار العضوية بشكل ملحوظ.",
    rating: 5,
  },
];
